"""Demonstrates multiclass MNIST TF Boosted trees example.
...
def get_input_fn(data, 
    ...
    def _input_fn():
        ...
        images_batch, labels_batch = tf.train.shuffle_batch(
            tensors = [images, labels.astype(np.int32)],
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type = float,
        default = 0.1,
        help = "Learning rate (chrinkage weight) with which each new tree is added." 
    )
    parser.add_argument(
        "--examples_per_layer",
        type = int,
